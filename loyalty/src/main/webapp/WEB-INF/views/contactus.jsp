  ...
  <body>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="contactus">คิดต่อเรา</a></li>
	...
	<div class="panel panel-danger">
        <div class="panel-heading">
          <h3 class="panel-title center-block">คิดต่อเรา</h3>
        </div>
        <div class="panel-body">
          
		      <div class="row featurette">
		        <div class="col-md-7">
		          <h2 class="featurette-heading">โทร :<span class="text-muted"> 0863603572</span></h2>
		          <p class="lead">บ้านเลขที่ 52/14 แขวงบางค้อ เขตจอมทอง กทม 10150</p>
		        </div>
		        <div class="col-md-5">
		          <img class="featurette-image img-responsive center-block" src="${context}/resources/img/google-maps.jpg" alt="Generic placeholder image">
		        </div>
		      </div>
